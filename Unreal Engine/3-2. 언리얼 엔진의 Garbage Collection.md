...
- [`Mark & Sweep`](https://en.wikipedia.org/wiki/Tracing_garbage_collection#:~:text=Na%C3%AFve%20mark-and-sweep%5Bedit,problems%20in%20paged%20memory%20systems.) 방식을 사용
